...
class button_color:
    ...
    def __init__(
        ...
        self,
        inactive_color: pygame.Color | tuple | list | str | None = None,
        active_color: pygame.Color | tuple | list | str | None = None,
        hover_color: pygame.Color | tuple | list | str | None = None,
        ...
        for key, value in self.kwargs_color.items():
            _prvt.asserting(isinstance(value, pygame.Color | tuple | list | str | None), TypeError(f'{key}: must be pygame.Color or tuple or list or str or None for default color type not {_prvt.get_type(value)}'))
...
class Button:
    ...
    def __init__(
            ...
            outline_size: int | float | None = None,
            image_transform: int | float | tuple | list | None = None,
            ...
            inactive_cursor: SystemCursor | pygame.Cursor | int | None = None,
            active_cursor: SystemCursor | pygame.Cursor | int | None = None,
            only_click: str | tuple | list = 'l',
            click_speed: int = 50,
    ...
    def __render_active_button(self, current_time: int, change_config: bool) -> None:
        ...
        if isinstance(self.outline_size, int | float):
    ...
    def __set_and_validates(self, kwargs: dict | None = None) -> None:
        ...
        if isinstance(self.image_transform, int | float):
        ...
        elif isinstance(self.image_transform, tuple | list):
...
class Range:
    ...
    def __init__(
        ...
        self,
        surface_screen: pygame.Surface,
        thumb_size: tuple | list | None = None,
    ...
    def __render_thumb_and_track_fill(self, type_draw: str) -> None:
        ...
        if isinstance(self.thumb_size, tuple | list):
    ...
    def __update(self, mouse_x: float | int, get_pressed: tuple | None) -> ButtonEvent:
        ...
        if isinstance(get_pressed, tuple):
            if get_pressed[0]:
    ...
    def __set_and_validates(self, kwargs: dict | None = None) -> None:
        ...
        _prvt.asserting(isinstance(self.click_speed, int), TypeError(f'click_speed: must be int type not {_prvt.get_type(self.click_speed)}'))
        _prvt.asserting(isinstance(self.min_value, float | int), TypeError(f'min_value: must be float or int type not {_prvt.get_type(self.min_value)}'))
        _prvt.asserting(isinstance(self.max_value, float | int), TypeError(f'max_value: must be float or int type not {_prvt.get_type(self.max_value)}'))
        _prvt.asserting(isinstance(self.value, float | int), TypeError(f'value: must be float or int type not {_prvt.get_type(self.value)}'))
        _prvt.asserting(self.click_speed >= 0, ValueError(f'click_speed: illegal below 0 -> {self.click_speed}'))
...
def SetAllCursorButtons(
    ...
    if not operator_collidepoint_buttons(*buttons):
        if not inactive_cursor is None:
